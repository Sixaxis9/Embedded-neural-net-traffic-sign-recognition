...
#define AI_NETWORK_MODEL_SIGNATURE     "773929224950b5e7ca5152ff0f6f25cc"
...
#define AI_TOOLS_DATE_TIME   "Wed May 27 12:38:52 2020"
...
AI_STATIC ai_array conv2d_9_scratch1_array;   /* Array #0 */
AI_STATIC ai_array conv2d_9_scratch0_array;   /* Array #1 */
...
AI_STATIC ai_array dense_14_bias_array;   /* Array #6 */
AI_STATIC ai_array dense_14_weights_array;   /* Array #7 */
AI_STATIC ai_array dense_13_bias_array;   /* Array #8 */
AI_STATIC ai_array dense_13_weights_array;   /* Array #9 */
AI_STATIC ai_array input_12_array;   /* Array #10 */
AI_STATIC ai_array input_11_array;   /* Array #11 */
AI_STATIC ai_array conv2d_9_bias_array;   /* Array #12 */
AI_STATIC ai_array conv2d_9_weights_array;   /* Array #13 */
AI_STATIC ai_array input_8_array;   /* Array #14 */
AI_STATIC ai_array input_7_array;   /* Array #15 */
AI_STATIC ai_array conv2d_5_bias_array;   /* Array #16 */
AI_STATIC ai_array conv2d_5_weights_array;   /* Array #17 */
AI_STATIC ai_array input_4_array;   /* Array #18 */
AI_STATIC ai_array input_3_array;   /* Array #19 */
AI_STATIC ai_array conv2d_1_bias_array;   /* Array #20 */
AI_STATIC ai_array conv2d_1_weights_array;   /* Array #21 */
AI_STATIC ai_array input_0_output_array;   /* Array #22 */
AI_STATIC ai_array conversion_0_output_array;   /* Array #23 */
AI_STATIC ai_array conv2d_1_output_array;   /* Array #24 */
AI_STATIC ai_array pool_2_fmt_output_array;   /* Array #25 */
AI_STATIC ai_array eltwise_3_output_array;   /* Array #26 */
AI_STATIC ai_array eltwise_3_fmt_output_array;   /* Array #27 */
AI_STATIC ai_array eltwise_4_output_array;   /* Array #28 */
AI_STATIC ai_array conv2d_5_output_array;   /* Array #29 */
AI_STATIC ai_array pool_6_fmt_output_array;   /* Array #30 */
AI_STATIC ai_array eltwise_7_output_array;   /* Array #31 */
AI_STATIC ai_array eltwise_7_fmt_output_array;   /* Array #32 */
AI_STATIC ai_array eltwise_8_output_array;   /* Array #33 */
AI_STATIC ai_array conv2d_9_output_array;   /* Array #34 */
AI_STATIC ai_array pool_10_fmt_output_array;   /* Array #35 */
AI_STATIC ai_array eltwise_11_output_array;   /* Array #36 */
AI_STATIC ai_array eltwise_11_fmt_output_array;   /* Array #37 */
AI_STATIC ai_array eltwise_12_output_array;   /* Array #38 */
AI_STATIC ai_array dense_13_output_array;   /* Array #39 */
AI_STATIC ai_array dense_14_output_array;   /* Array #40 */
AI_STATIC ai_array dense_14_fmt_output_array;   /* Array #41 */
AI_STATIC ai_array nl_15_output_array;   /* Array #42 */


/**  Forward network tensor declarations  *************************************/
AI_STATIC ai_tensor conv2d_9_scratch1;   /* Tensor #0 */
AI_STATIC ai_tensor conv2d_9_scratch0;   /* Tensor #1 */
...
AI_STATIC ai_tensor dense_14_bias;   /* Tensor #6 */
AI_STATIC ai_tensor dense_14_weights;   /* Tensor #7 */
AI_STATIC ai_tensor dense_13_bias;   /* Tensor #8 */
AI_STATIC ai_tensor dense_13_weights;   /* Tensor #9 */
AI_STATIC ai_tensor input_12;   /* Tensor #10 */
AI_STATIC ai_tensor input_11;   /* Tensor #11 */
AI_STATIC ai_tensor conv2d_9_bias;   /* Tensor #12 */
AI_STATIC ai_tensor conv2d_9_weights;   /* Tensor #13 */
AI_STATIC ai_tensor input_8;   /* Tensor #14 */
AI_STATIC ai_tensor input_7;   /* Tensor #15 */
AI_STATIC ai_tensor conv2d_5_bias;   /* Tensor #16 */
AI_STATIC ai_tensor conv2d_5_weights;   /* Tensor #17 */
AI_STATIC ai_tensor input_4;   /* Tensor #18 */
AI_STATIC ai_tensor input_3;   /* Tensor #19 */
AI_STATIC ai_tensor conv2d_1_bias;   /* Tensor #20 */
AI_STATIC ai_tensor conv2d_1_weights;   /* Tensor #21 */
AI_STATIC ai_tensor input_0_output;   /* Tensor #22 */
AI_STATIC ai_tensor conversion_0_output;   /* Tensor #23 */
AI_STATIC ai_tensor conv2d_1_output;   /* Tensor #24 */
AI_STATIC ai_tensor pool_2_fmt_output;   /* Tensor #25 */
AI_STATIC ai_tensor eltwise_3_output;   /* Tensor #26 */
AI_STATIC ai_tensor eltwise_3_fmt_output;   /* Tensor #27 */
AI_STATIC ai_tensor eltwise_4_output;   /* Tensor #28 */
AI_STATIC ai_tensor conv2d_5_output;   /* Tensor #29 */
AI_STATIC ai_tensor pool_6_fmt_output;   /* Tensor #30 */
AI_STATIC ai_tensor eltwise_7_output;   /* Tensor #31 */
AI_STATIC ai_tensor eltwise_7_fmt_output;   /* Tensor #32 */
AI_STATIC ai_tensor eltwise_8_output;   /* Tensor #33 */
AI_STATIC ai_tensor conv2d_9_output;   /* Tensor #34 */
AI_STATIC ai_tensor pool_10_fmt_output;   /* Tensor #35 */
AI_STATIC ai_tensor eltwise_11_output;   /* Tensor #36 */
AI_STATIC ai_tensor eltwise_11_fmt_output;   /* Tensor #37 */
AI_STATIC ai_tensor eltwise_12_output;   /* Tensor #38 */
AI_STATIC ai_tensor dense_13_output;   /* Tensor #39 */
AI_STATIC ai_tensor dense_14_output;   /* Tensor #40 */
AI_STATIC ai_tensor dense_14_fmt_output;   /* Tensor #41 */
AI_STATIC ai_tensor nl_15_output;   /* Tensor #42 */


/**  Forward network tensor chain declarations  *******************************/
AI_STATIC_CONST ai_tensor_chain conversion_0_chain;   /* Chain #0 */
AI_STATIC_CONST ai_tensor_chain conv2d_1_chain;   /* Chain #1 */
AI_STATIC_CONST ai_tensor_chain pool_2_fmt_chain;   /* Chain #2 */
AI_STATIC_CONST ai_tensor_chain eltwise_3_chain;   /* Chain #3 */
AI_STATIC_CONST ai_tensor_chain eltwise_3_fmt_chain;   /* Chain #4 */
AI_STATIC_CONST ai_tensor_chain eltwise_4_chain;   /* Chain #5 */
AI_STATIC_CONST ai_tensor_chain conv2d_5_chain;   /* Chain #6 */
AI_STATIC_CONST ai_tensor_chain pool_6_fmt_chain;   /* Chain #7 */
AI_STATIC_CONST ai_tensor_chain eltwise_7_chain;   /* Chain #8 */
AI_STATIC_CONST ai_tensor_chain eltwise_7_fmt_chain;   /* Chain #9 */
AI_STATIC_CONST ai_tensor_chain eltwise_8_chain;   /* Chain #10 */
AI_STATIC_CONST ai_tensor_chain conv2d_9_chain;   /* Chain #11 */
AI_STATIC_CONST ai_tensor_chain pool_10_fmt_chain;   /* Chain #12 */
AI_STATIC_CONST ai_tensor_chain eltwise_11_chain;   /* Chain #13 */
AI_STATIC_CONST ai_tensor_chain eltwise_11_fmt_chain;   /* Chain #14 */
AI_STATIC_CONST ai_tensor_chain eltwise_12_chain;   /* Chain #15 */
AI_STATIC_CONST ai_tensor_chain dense_13_chain;   /* Chain #16 */
AI_STATIC_CONST ai_tensor_chain dense_14_chain;   /* Chain #17 */
AI_STATIC_CONST ai_tensor_chain dense_14_fmt_chain;   /* Chain #18 */
AI_STATIC_CONST ai_tensor_chain nl_15_chain;   /* Chain #19 */


/**  Forward network layer declarations  **************************************/
AI_STATIC ai_layer_nl conversion_0_layer; /* Layer #0 */
AI_STATIC ai_layer_conv2d_nl_pool conv2d_1_layer; /* Layer #1 */
AI_STATIC ai_layer_nl pool_2_fmt_layer; /* Layer #2 */
AI_STATIC ai_layer_eltwise eltwise_3_layer; /* Layer #3 */
AI_STATIC ai_layer_nl eltwise_3_fmt_layer; /* Layer #4 */
AI_STATIC ai_layer_eltwise eltwise_4_layer; /* Layer #5 */
AI_STATIC ai_layer_conv2d_nl_pool conv2d_5_layer; /* Layer #6 */
AI_STATIC ai_layer_nl pool_6_fmt_layer; /* Layer #7 */
AI_STATIC ai_layer_eltwise eltwise_7_layer; /* Layer #8 */
AI_STATIC ai_layer_nl eltwise_7_fmt_layer; /* Layer #9 */
AI_STATIC ai_layer_eltwise eltwise_8_layer; /* Layer #10 */
AI_STATIC ai_layer_conv2d_nl_pool conv2d_9_layer; /* Layer #11 */
AI_STATIC ai_layer_nl pool_10_fmt_layer; /* Layer #12 */
AI_STATIC ai_layer_eltwise eltwise_11_layer; /* Layer #13 */
AI_STATIC ai_layer_nl eltwise_11_fmt_layer; /* Layer #14 */
AI_STATIC ai_layer_eltwise eltwise_12_layer; /* Layer #15 */
AI_STATIC ai_layer_dense dense_13_layer; /* Layer #16 */
AI_STATIC ai_layer_dense dense_14_layer; /* Layer #17 */
AI_STATIC ai_layer_nl dense_14_fmt_layer; /* Layer #18 */
AI_STATIC ai_layer_nl nl_15_layer; /* Layer #19 */
...
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 10000,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    input_12_array, AI_ARRAY_FORMAT_S8,
    NULL, NULL, 100,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    input_11_array, AI_ARRAY_FORMAT_FLOAT,
    NULL, NULL, 100,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
...
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 80000,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    input_8_array, AI_ARRAY_FORMAT_S8,
    NULL, NULL, 50,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    input_7_array, AI_ARRAY_FORMAT_FLOAT,
    NULL, NULL, 50,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
...
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 8000,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    input_4_array, AI_ARRAY_FORMAT_S8,
    NULL, NULL, 10,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    input_3_array, AI_ARRAY_FORMAT_FLOAT,
    NULL, NULL, 10,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
...
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 1690,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    pool_2_fmt_output_array, AI_ARRAY_FORMAT_FLOAT,
    NULL, NULL, 1690,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 1690,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    eltwise_3_fmt_output_array, AI_ARRAY_FORMAT_S8,
    NULL, NULL, 1690,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
...
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 1250,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    pool_6_fmt_output_array, AI_ARRAY_FORMAT_FLOAT,
    NULL, NULL, 1250,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 1250,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    eltwise_7_fmt_output_array, AI_ARRAY_FORMAT_S8,
    NULL, NULL, 1250,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
...
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 100,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    pool_10_fmt_output_array, AI_ARRAY_FORMAT_FLOAT,
    NULL, NULL, 100,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 100,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    eltwise_11_fmt_output_array, AI_ARRAY_FORMAT_S8,
    NULL, NULL, 100,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
...
AI_ARRAY_OBJ_DECLARE(
    ...
    NULL, NULL, 43,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
    dense_14_fmt_output_array, AI_ARRAY_FORMAT_FLOAT,
    NULL, NULL, 43,
     AI_STATIC)
AI_ARRAY_OBJ_DECLARE(
...
AI_STATIC ai_intq_info_list conv2d_1_scratch1_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.004687373526394367f), AI_PACK_INTQ_ZP(-128)));   /* Int quant #2 */
AI_STATIC ai_intq_info_list dense_14_bias_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0005653419066220522f), AI_PACK_INTQ_ZP(0)));   /* Int quant #3 */
AI_STATIC ai_intq_info_list dense_14_weights_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
...
AI_STATIC ai_intq_info_list input_12_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
...
AI_STATIC ai_intq_info_list input_8_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
...
AI_STATIC ai_intq_info_list input_4_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
...
AI_STATIC ai_intq_info_list eltwise_3_fmt_output_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.038692228496074677f), AI_PACK_INTQ_ZP(-128)));   /* Int quant #18 */
AI_STATIC ai_intq_info_list eltwise_4_output_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
...
AI_STATIC ai_intq_info_list eltwise_7_fmt_output_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.09601124376058578f), AI_PACK_INTQ_ZP(-128)));   /* Int quant #21 */
AI_STATIC ai_intq_info_list eltwise_8_output_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
...
AI_STATIC ai_intq_info_list eltwise_11_fmt_output_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
...
AI_STATIC ai_intq_info_list dense_14_output_intq = AI_INTQ_INFO_LIST_OBJ_INIT(
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1, AI_PACK_INTQ_INFO(
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, &input_12_array, &input_12_intq)
AI_TENSOR_OBJ_DECLARE(
  input_11, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 100, 1, 1), AI_STRIDE_INIT(4, 4, 4, 400, 400),
  1, &input_11_array, NULL)
AI_TENSOR_OBJ_DECLARE(
...
AI_TENSOR_OBJ_DECLARE(
  pool_2_fmt_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 10, 13, 13), AI_STRIDE_INIT(4, 4, 4, 40, 520),
  1, &pool_2_fmt_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  eltwise_3_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 10, 13, 13), AI_STRIDE_INIT(4, 4, 4, 40, 520),
  1, &eltwise_3_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  eltwise_3_fmt_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 10, 13, 13), AI_STRIDE_INIT(4, 1, 1, 10, 130),
  1, &eltwise_3_fmt_output_array, &eltwise_3_fmt_output_intq)
AI_TENSOR_OBJ_DECLARE(
...
AI_TENSOR_OBJ_DECLARE(
  pool_6_fmt_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 50, 5, 5), AI_STRIDE_INIT(4, 4, 4, 200, 1000),
  1, &pool_6_fmt_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  eltwise_7_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 50, 5, 5), AI_STRIDE_INIT(4, 4, 4, 200, 1000),
  1, &eltwise_7_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  eltwise_7_fmt_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 50, 5, 5), AI_STRIDE_INIT(4, 1, 1, 50, 250),
  1, &eltwise_7_fmt_output_array, &eltwise_7_fmt_output_intq)
AI_TENSOR_OBJ_DECLARE(
...
AI_TENSOR_OBJ_DECLARE(
  pool_10_fmt_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 100, 1, 1), AI_STRIDE_INIT(4, 4, 4, 400, 400),
  1, &pool_10_fmt_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  eltwise_11_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 100, 1, 1), AI_STRIDE_INIT(4, 4, 4, 400, 400),
  1, &eltwise_11_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  eltwise_11_fmt_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 100, 1, 1), AI_STRIDE_INIT(4, 1, 1, 100, 100),
  1, &eltwise_11_fmt_output_array, &eltwise_11_fmt_output_intq)
AI_TENSOR_OBJ_DECLARE(
...
AI_TENSOR_OBJ_DECLARE(
  dense_14_fmt_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 43, 1, 1), AI_STRIDE_INIT(4, 4, 4, 172, 172),
  1, &dense_14_fmt_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_ENTRY(&conv2d_1_scratch0, &conv2d_1_scratch1)
)
...
AI_LAYER_OBJ_DECLARE(
  ...
  &AI_NET_OBJ_INSTANCE, &pool_2_fmt_layer, AI_STATIC,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  pool_2_fmt_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&conv2d_1_output),
  AI_TENSOR_LIST_ENTRY(&pool_2_fmt_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)
...
AI_LAYER_OBJ_DECLARE(
  ...
  .tensors = &pool_2_fmt_chain, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  eltwise_3_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&pool_2_fmt_output, &input_3),
...
AI_LAYER_OBJ_DECLARE(
  ...
  &AI_NET_OBJ_INSTANCE, &eltwise_3_fmt_layer, AI_STATIC,
  .tensors = &eltwise_3_chain, 
  .operation = ai_mul, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  eltwise_3_fmt_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&eltwise_3_output),
  AI_TENSOR_LIST_ENTRY(&eltwise_3_fmt_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  eltwise_3_fmt_layer, 3,
  NL_TYPE,
  nl, node_convert,
  &AI_NET_OBJ_INSTANCE, &eltwise_4_layer, AI_STATIC,
  .tensors = &eltwise_3_fmt_chain, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  eltwise_4_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&eltwise_3_fmt_output, &input_4),
  AI_TENSOR_LIST_ENTRY(&eltwise_4_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)
...
AI_LAYER_OBJ_DECLARE(
  ...
  OPTIMIZED_CONV2D_TYPE,
  conv2d_nl_pool, forward_conv2d_nl_pool_integer,
  &AI_NET_OBJ_INSTANCE, &pool_6_fmt_layer, AI_STATIC,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  pool_6_fmt_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&conv2d_5_output),
  AI_TENSOR_LIST_ENTRY(&pool_6_fmt_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)
...
AI_LAYER_OBJ_DECLARE(
  ...
  .tensors = &pool_6_fmt_chain, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  eltwise_7_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&pool_6_fmt_output, &input_7),
...
AI_LAYER_OBJ_DECLARE(
  ...
  ELTWISE_TYPE,
  eltwise, forward_eltwise,
  &AI_NET_OBJ_INSTANCE, &eltwise_7_fmt_layer, AI_STATIC,
  .tensors = &eltwise_7_chain, 
  .operation = ai_mul, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  eltwise_7_fmt_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&eltwise_7_output),
  AI_TENSOR_LIST_ENTRY(&eltwise_7_fmt_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  eltwise_7_fmt_layer, 7,
  NL_TYPE,
  nl, node_convert,
  &AI_NET_OBJ_INSTANCE, &eltwise_8_layer, AI_STATIC,
  .tensors = &eltwise_7_fmt_chain, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  eltwise_8_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&eltwise_7_fmt_output, &input_8),
  AI_TENSOR_LIST_ENTRY(&eltwise_8_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)
...
AI_LAYER_OBJ_DECLARE(
  ...
  OPTIMIZED_CONV2D_TYPE,
  conv2d_nl_pool, forward_conv2d_nl_pool_integer,
  &AI_NET_OBJ_INSTANCE, &pool_10_fmt_layer, AI_STATIC,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  pool_10_fmt_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&conv2d_9_output),
  AI_TENSOR_LIST_ENTRY(&pool_10_fmt_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  pool_10_fmt_layer, 10,
  NL_TYPE,
  nl, node_convert,
  &AI_NET_OBJ_INSTANCE, &eltwise_11_layer, AI_STATIC,
  .tensors = &pool_10_fmt_chain, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  eltwise_11_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&pool_10_fmt_output, &input_11),
...
AI_LAYER_OBJ_DECLARE(
  ...
  ELTWISE_TYPE,
  eltwise, forward_eltwise,
  &AI_NET_OBJ_INSTANCE, &eltwise_11_fmt_layer, AI_STATIC,
  .tensors = &eltwise_11_chain, 
  .operation = ai_mul, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  eltwise_11_fmt_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&eltwise_11_output),
  AI_TENSOR_LIST_ENTRY(&eltwise_11_fmt_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  eltwise_11_fmt_layer, 11,
  NL_TYPE,
  nl, node_convert,
  &AI_NET_OBJ_INSTANCE, &eltwise_12_layer, AI_STATIC,
  .tensors = &eltwise_11_fmt_chain, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  eltwise_12_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&eltwise_11_fmt_output, &input_12),
...
AI_LAYER_OBJ_DECLARE(
  ...
  &AI_NET_OBJ_INSTANCE, &dense_14_layer, AI_STATIC,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_ENTRY(&dense_13_output),
  AI_TENSOR_LIST_ENTRY(&dense_14_output),
  AI_TENSOR_LIST_ENTRY(&dense_14_weights, &dense_14_bias),
  AI_TENSOR_LIST_EMPTY
)
...
AI_LAYER_OBJ_DECLARE(
  ...
  DENSE_TYPE,
  dense, forward_dense_integer,
  &AI_NET_OBJ_INSTANCE, &dense_14_fmt_layer, AI_STATIC,
  .tensors = &dense_14_chain, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  dense_14_fmt_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&dense_14_output),
  AI_TENSOR_LIST_ENTRY(&dense_14_fmt_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  dense_14_fmt_layer, 14,
  NL_TYPE,
  nl, node_convert,
  &AI_NET_OBJ_INSTANCE, &nl_15_layer, AI_STATIC,
  .tensors = &dense_14_fmt_chain, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  nl_15_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_ENTRY(&dense_14_fmt_output),
  AI_TENSOR_LIST_ENTRY(&nl_15_output),
  AI_TENSOR_LIST_EMPTY,
  AI_TENSOR_LIST_EMPTY
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_15_output),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_9_scratch1_array.data = AI_PTR(activations + 5852);
    conv2d_9_scratch1_array.data_start = AI_PTR(activations + 5852);
    conv2d_9_scratch0_array.data = AI_PTR(activations + 1252);
    conv2d_9_scratch0_array.data_start = AI_PTR(activations + 1252);
    conv2d_5_scratch1_array.data = AI_PTR(activations + 3032);
    conv2d_5_scratch1_array.data_start = AI_PTR(activations + 3032);
    conv2d_5_scratch0_array.data = AI_PTR(activations + 1692);
    conv2d_5_scratch0_array.data_start = AI_PTR(activations + 1692);
    conv2d_1_scratch1_array.data = AI_PTR(activations + 1360);
    conv2d_1_scratch1_array.data_start = AI_PTR(activations + 1360);
    conv2d_1_scratch0_array.data = AI_PTR(activations + 1024);
    conv2d_1_scratch0_array.data_start = AI_PTR(activations + 1024);
    ...
    conv2d_1_output_array.data = AI_PTR(activations + 6760);
    conv2d_1_output_array.data_start = AI_PTR(activations + 6760);
    pool_2_fmt_output_array.data = AI_PTR(activations + 0);
    pool_2_fmt_output_array.data_start = AI_PTR(activations + 0);
    eltwise_3_output_array.data = AI_PTR(activations + 6760);
    eltwise_3_output_array.data_start = AI_PTR(activations + 6760);
    eltwise_3_fmt_output_array.data = AI_PTR(activations + 6760);
    eltwise_3_fmt_output_array.data_start = AI_PTR(activations + 6760);
    eltwise_4_output_array.data = AI_PTR(activations + 0);
    eltwise_4_output_array.data_start = AI_PTR(activations + 0);
    conv2d_5_output_array.data = AI_PTR(activations + 5000);
    conv2d_5_output_array.data_start = AI_PTR(activations + 5000);
    pool_6_fmt_output_array.data = AI_PTR(activations + 0);
    pool_6_fmt_output_array.data_start = AI_PTR(activations + 0);
    eltwise_7_output_array.data = AI_PTR(activations + 5000);
    eltwise_7_output_array.data_start = AI_PTR(activations + 5000);
    eltwise_7_fmt_output_array.data = AI_PTR(activations + 5000);
    eltwise_7_fmt_output_array.data_start = AI_PTR(activations + 5000);
    eltwise_8_output_array.data = AI_PTR(activations + 0);
    eltwise_8_output_array.data_start = AI_PTR(activations + 0);
    conv2d_9_output_array.data = AI_PTR(activations + 6252);
    conv2d_9_output_array.data_start = AI_PTR(activations + 6252);
    pool_10_fmt_output_array.data = AI_PTR(activations + 0);
    pool_10_fmt_output_array.data_start = AI_PTR(activations + 0);
    eltwise_11_output_array.data = AI_PTR(activations + 400);
    eltwise_11_output_array.data_start = AI_PTR(activations + 400);
    eltwise_11_fmt_output_array.data = AI_PTR(activations + 400);
    eltwise_11_fmt_output_array.data_start = AI_PTR(activations + 400);
    eltwise_12_output_array.data = AI_PTR(activations + 0);
    eltwise_12_output_array.data_start = AI_PTR(activations + 0);
    dense_13_output_array.data = AI_PTR(activations + 100);
    dense_13_output_array.data_start = AI_PTR(activations + 100);
    dense_14_output_array.data = AI_PTR(activations + 0);
    dense_14_output_array.data_start = AI_PTR(activations + 0);
    dense_14_fmt_output_array.data = AI_PTR(activations + 44);
    dense_14_fmt_output_array.data_start = AI_PTR(activations + 44);
    nl_15_output_array.data = AI_PTR(NULL);
    nl_15_output_array.data_start = AI_PTR(NULL);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_14_bias_array.data = AI_PTR(weights + 104636);
    dense_14_bias_array.data_start = AI_PTR(weights + 104636);
    dense_14_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_14_weights_array.data = AI_PTR(weights + 100336);
    dense_14_weights_array.data_start = AI_PTR(weights + 100336);
    dense_13_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_13_bias_array.data = AI_PTR(weights + 99936);
    dense_13_bias_array.data_start = AI_PTR(weights + 99936);
    dense_13_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_13_weights_array.data = AI_PTR(weights + 89936);
    dense_13_weights_array.data_start = AI_PTR(weights + 89936);
    input_12_array.format |= AI_FMT_FLAG_CONST;
    input_12_array.data = AI_PTR(weights + 89836);
    input_12_array.data_start = AI_PTR(weights + 89836);
    input_11_array.format |= AI_FMT_FLAG_CONST;
    input_11_array.data = AI_PTR(weights + 89436);
    input_11_array.data_start = AI_PTR(weights + 89436);
    conv2d_9_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_9_bias_array.data = AI_PTR(weights + 89036);
    conv2d_9_bias_array.data_start = AI_PTR(weights + 89036);
    conv2d_9_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_9_weights_array.data = AI_PTR(weights + 9036);
    conv2d_9_weights_array.data_start = AI_PTR(weights + 9036);
    input_8_array.format |= AI_FMT_FLAG_CONST;
    input_8_array.data = AI_PTR(weights + 8984);
    input_8_array.data_start = AI_PTR(weights + 8984);
    input_7_array.format |= AI_FMT_FLAG_CONST;
    input_7_array.data = AI_PTR(weights + 8784);
    input_7_array.data_start = AI_PTR(weights + 8784);
    conv2d_5_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_5_bias_array.data = AI_PTR(weights + 8584);
    conv2d_5_bias_array.data_start = AI_PTR(weights + 8584);
    conv2d_5_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_5_weights_array.data = AI_PTR(weights + 584);
    conv2d_5_weights_array.data_start = AI_PTR(weights + 584);
    input_4_array.format |= AI_FMT_FLAG_CONST;
    input_4_array.data = AI_PTR(weights + 572);
    input_4_array.data_start = AI_PTR(weights + 572);
    input_3_array.format |= AI_FMT_FLAG_CONST;
    input_3_array.data = AI_PTR(weights + 532);
    input_3_array.data_start = AI_PTR(weights + 532);
    conv2d_1_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_1_bias_array.data = AI_PTR(weights + 492);
    conv2d_1_bias_array.data_start = AI_PTR(weights + 492);
